...
export const CreatePageTemplate = (props: RouteComponentProps) => {
			...
			<Grid.Column computer='7' mobile='12'>
				{success ? (
					<React.Fragment>
						<Message
							success
							content={ `Организация '${ name }' успешно создана` } />
						<Grid>
							<Grid.Column textAlign='center'>
								<Button as={Link} to='/login' basic color='black'>Войти</Button>
							</Grid.Column>
						</Grid>
					</React.Fragment>
				) : (
